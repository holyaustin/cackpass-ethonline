// app/api/admin/contract/pause/route.ts
...
export async function POST(request: NextRequest) {
  try {
    const ctx = await requireAdmin(request, PERMISSIONS.PAUSE_CONTRACT)
    ...
    await logAdminAction(ctx, 'contract.pause', 'registry', { txHash: tx.hash })
