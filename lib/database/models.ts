...
const OrderSchema = new mongoose.Schema({
  ...
  paymentMethod: { type: String, enum: ['paystack', 'flutterwave', 'arc_usdc', 'wallet', 'free'], required: true },
...
const PaymentSchema = new mongoose.Schema({
  paymentMethod: { type: String, enum: ['wallet', 'paystack', 'arc_usdc','flutterwave', 'crypto', 'free'], required: true },
